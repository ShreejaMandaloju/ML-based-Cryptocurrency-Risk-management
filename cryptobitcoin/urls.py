...
from agents.views import bitagentregister,agentlogincheck,AgentBuyCrypto,agentbuycurrency,AgentTransactions,AgentHadCoins,AgentLedgerStatus,AgentPredectionTest,AgentPredictTestProcess
...
urlpatterns = [
    ...
    path('AgentPredictTestProcess/<value>',AgentPredictTestProcess,name='AgentPredictTestProcess'),
